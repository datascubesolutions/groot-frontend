...
import { domAnimation, LazyMotion, m, useScroll, useSpring } from "framer-motion";
  ...
  return (
    ...
    >
      <div className="flex-1 flex justify-center lg:justify-end order-1 lg:order-none w-full">
        <div
          className={`
            relative group p-6 rounded-2xl bg-card border border-border shadow-lg shadow-charcoal/5
