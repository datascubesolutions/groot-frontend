...
export const TECH_STACK = [
  {
    ...
    icon: Cloud,
    description:
      "Multi-cloud infrastructure and services providing the foundation for scalable solutions.",
    subcategories: [
      {
        ...
        items: [
          ...
          },
          {
            ...
            description: "AI development and deployment",
          },
        ],
      },
      {
  ...
  },
  {
    ...
    icon: Code2,
    description:
      "Robust data processing, orchestration, and transformation at scale.",
    subcategories: [
      {
  ...
  },
  {
    ...
    icon: BarChart,
    description:
      "Advanced visualization, reporting, and enterprise data warehousing.",
    subcategories: [
      {
  ...
  },
  {
    ...
    icon: Brain,
    description:
      "Cutting-edge AI platforms, frameworks, and MLOps for intelligent solutions.",
    subcategories: [
      {
        name: "AI Platforms",
        items: [
          {
            name: "Microsoft AI Foundry",
            description: "Enterprise AI development",
          },
          {
      ...
      },
      {
        ...
        items: [
          ...
          {
            name: "Azure Cognitive Services",
            description: "Speech, vision, language AI",
          },
          {
  ...
  },
  {
    ...
    icon: Terminal,
    description:
      "Streamlined deployment, orchestration, and infrastructure as code.",
    subcategories: [
      {
  ...
  },
  {
    ...
    icon: ShieldCheck,
    description:
      "Ensuring data integrity, compliance, and comprehensive governance.",
    subcategories: [
      {
        ...
        items: [
          ...
          {
            name: "Azure Purview",
            description: "Data governance and discovery",
          },
    ...
    subcategories: [
      {
        ...
        items: [
          ...
          { name: "Azure Monitor", description: "Cloud monitoring" },
          {
            ...
            description: "AWS monitoring and logging",
          },
          {
  ...
  },
  {
    ...
    icon: Users,
    description:
      "Tools for effective project management and team communication.",
    subcategories: [
      {
