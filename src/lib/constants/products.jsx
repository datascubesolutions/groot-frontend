...
export const productData = [
  {
    ...
    features: [
      {
        title: "Compute",
        description: "Azure VMs, App Service, and Kubernetes (AKS)",
      },
      {
        title: "Storage",
        description: "Azure Blob Storage and Data Lake Gen2",
      },
      {
        title: "Networking",
        description: "Virtual Network, Front Door, ExpressRoute",
      },
  ...
  },
  {
    ...
    features: [
      {
        title: "OneLake",
        description: "The OneDrive for data - single source of truth",
      },
      {
        title: "Synapse",
        description: "Data Engineering, Science, and Warehousing",
      },
      {
        title: "Data Factory",
        description: "Data integration and transformation flows",
      },
      {
        title: "Power BI",
        description: "Industry-leading business intelligence built-in",
      },
      {
        title: "Real-Time",
        description: "Observability and event stream processing",
      },
  ...
  },
  {
    ...
    features: [
      ...
      {
        title: "Delta Lake",
        description: "Open source storage layer for reliability",
      },
      {
        title: "Photon",
        description: "High-performance vectorized query engine",
      },
      {
        title: "Data Science",
        description: "Collaborative notebooks and ML environment",
      },
      {
        title: "SQL Warehouse",
        description: "Serverless compute for BI and SQL",
      },
      {
        title: "Streaming",
        description: "Structured Streaming for real-time data",
      },
    ],
    imagePosition: "right",
    bgVariant: "default",
  ...
  },
  {
    ...
    features: [
      {
        title: "Model Catalog",
        description: "Access GPT-4, Llama 2, and more",
      },
      {
        title: "AI Studio",
        description: "Unified interface for AI development",
      },
      {
        title: "Safety",
        description: "Content safety and responsible AI tools",
      },
      {
        title: "Prompt Flow",
        description: "Streamlined development of AI applications",
      },
      {
        title: "Evaluation",
        description: "Tools to test and benchmark models",
      },
