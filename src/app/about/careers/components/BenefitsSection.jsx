...
const STYLES = {
  ...
  ambientLight: "absolute top-0 right-0 w-[600px] h-[600px] bg-primary/5 rounded-full blur-[100px] pointer-events-none",
  ...
  heading: "text-4xl md:text-5xl lg:text-6xl font-black tracking-tighter mb-6 text-foreground",
  ...
  iconWrapper: "w-20 h-20 rounded-2xl bg-background border border-border/80 flex items-center justify-center text-primary mb-8 shadow-sm group-hover:scale-110 group-hover:bg-primary/5 group-hover:border-primary/30 transition-all duration-500",
  cardTitle: "font-bold text-2xl lg:text-3xl mb-4 text-foreground tracking-tight",
    ...
    <section className={STYLES.section}>
      ...
      <div className={STYLES.container}>
        <div className={STYLES.headerWrapper}>
          ...
          <p className={STYLES.subheading}>Equipping our team to deliver the highest tier of engineering without the burnout.</p>
        </div>
