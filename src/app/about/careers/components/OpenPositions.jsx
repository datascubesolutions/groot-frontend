...
const STYLES = {
  ...
  bgBottomLeft:
    "absolute bottom-0 left-[-20%] w-[1000px] h-[1000px] bg-[radial-gradient(circle_at_bottom_left,hsl(var(--forest)/0.05),transparent_60%)] pointer-events-none",
  ...
  stickyColumn:
    "lg:col-span-5 lg:sticky top-40 mb-16 lg:mb-0 hidden lg:flex flex-col",
  stickyCard:
    "relative p-12 rounded-[3rem] bg-card border border-border shadow-2xl overflow-hidden aspect-square flex flex-col justify-center",
  spinnerBg: "absolute inset-0 z-0 opacity-10 flex items-center justify-center",
  spinner1:
    "w-[150%] h-[150%] border border-primary rounded-full animate-[spin_60s_linear_infinite]",
  spinner2:
    "absolute w-[120%] h-[120%] border border-foreground/50 rounded-full animate-[spin_40s_linear_infinite_reverse]",
  spinner3:
    "absolute w-[90%] h-[90%] border border-dashed border-primary/50 rounded-full animate-[spin_30s_linear_infinite]",
  ...
  heading:
    "text-5xl lg:text-7xl font-black tracking-tighter mb-8 text-foreground leading-[1] text-balance drop-shadow-sm",
  headingAccent:
    "text-transparent bg-clip-text bg-gradient-to-br from-primary via-forest to-foreground",
  paragraph:
    "text-xl text-muted-foreground font-medium text-balance leading-relaxed mb-10",
  ...
  pillDefault:
    "px-5 py-2 rounded-full bg-background border border-border shadow-sm text-foreground tracking-[0.1em] uppercase text-xs font-bold",
  pillExperience:
    "px-5 py-2 rounded-full bg-background border border-border shadow-sm text-foreground tracking-[0.1em] uppercase text-xs font-bold flex items-center gap-2",
  ...
  actionText:
    "text-sm font-black text-muted-foreground uppercase tracking-widest group-hover:text-forest transition-colors xl:mb-12",
  actionButton:
    "flex items-center justify-center w-16 h-16 rounded-full bg-background border-[2px] border-border text-foreground group-hover:bg-forest group-hover:border-forest group-hover:text-forest-foreground transition-all duration-300",
