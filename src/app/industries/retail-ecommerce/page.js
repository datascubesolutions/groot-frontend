        ...
        <div className="container relative z-10 mx-auto max-w-7xl px-6">
          ...
          <div className="grid auto-rows-fr grid-cols-1 gap-6 md:grid-cols-12">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              variants={fadeIn}
              className="relative overflow-hidden rounded-[2rem] border border-border/60 bg-background/80 p-6 lg:p-8 shadow-sm backdrop-blur-sm transition-colors hover:border-pink-500/40 md:col-span-4"
            >
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              variants={fadeIn}
              className="relative overflow-hidden rounded-[2rem] border border-border/60 bg-background/80 p-6 lg:p-8 shadow-sm backdrop-blur-sm transition-colors hover:border-pink-500/40 md:col-span-8"
            >
              <div className="relative z-10">
                <div className="mb-6 inline-flex h-12 w-12 items-center justify-center rounded-2xl bg-pink-500/10 text-pink-500 ring-1 ring-pink-500/30 transition-all duration-300 group-hover:bg-pink-500/20">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              variants={fadeIn}
              className="relative overflow-hidden rounded-[2rem] border border-border/60 bg-background/80 p-6 lg:p-8 shadow-sm backdrop-blur-sm transition-colors hover:border-pink-500/40 md:col-span-12"
            >
              <div className="relative z-10">
                <div className="mb-6 inline-flex h-12 w-12 items-center justify-center rounded-2xl bg-pink-500/10 text-pink-500 ring-1 ring-pink-500/30 transition-all duration-300 group-hover:bg-pink-500/20">
        ...
        <div className="container relative z-10 mx-auto max-w-6xl px-6">
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
            <motion.div
              ...
              variants={fadeIn}
              className="rounded-[2rem] border border-border/60 bg-muted/20 p-6 lg:p-8 shadow-sm backdrop-blur-sm transition-all duration-300 hover:border-pink-500/30"
            >
