...
export const metadata = {
  title: "Manufacturing & Supply Chain Analytics | Groot Analytics",
  description: "Connect shop floor operations with executive reporting. Optimize inventory, production, and supply chain with Microsoft Fabric.",
};
    ...
    <main className="pt-20">
      <Breadcrumb
        items={[
          ...
          { label: "Manufacturing & Supply Chain", href: "/industries/manufacturing-supply-chain" },
        ]}
      />
      ...
      <section className="relative py-24 bg-background border-b border-border overflow-hidden p-6">
        <div className="container mx-auto relative z-10 max-w-5xl text-center md:text-left">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-primary/20 bg-primary/5 text-primary text-sm font-semibold mb-6">
            ...
            <span>Shop Floor to Top Floor</span>
          </div>
          <h1 className="text-4xl md:text-6xl font-bold mb-6 tracking-tight">
            Manufacturing Analytics
          </h1>
          <p className="text-xl md:text-2xl text-muted-foreground mb-10 leading-relaxed max-w-3xl">
            Bridge the gap between operational technology and executive decision-making. We build connected data models that optimize production and reduce downtime.
          </p>
        ...
        <div className="container mx-auto px-6 max-w-5xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <UseCaseCard
              ...
              desc="Combine machine telemetry with maintenance logs to predict failures before they stop the line."
            />
            <UseCaseCard
              id="02"
              title="Inventory Optimization"
              desc="Balance carrying costs with stockout risks using advanced demand forecasting models."
            />
            <UseCaseCard
              id="03"
              title="Yield Analysis"
              desc="Identify root causes of quality defects by connecting production parameters with QA results."
            />
          </div>
        </div>
      </section>
