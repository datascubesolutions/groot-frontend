...
export default function SemanticModeling() {
 ...
 <section className="relative overflow-hidden bg-muted/20 py-16 lg:py-24 md:py-16 lg:py-24 lg:py-16 lg:py-24">
 ...
 {/* FAQ */}
 <section className="overflow-x-clip bg-muted/20 py-16 lg:py-24 lg:py-16 lg:py-24">
 ...
 {/* Related Services */}
 <section className="overflow-x-clip bg-background py-16 lg:py-24 lg:py-16 lg:py-24">
