  ...
  return (
    <main className="min-h-screen overflow-x-clip bg-background pt-20 font-sans selection:bg-forest/30">
      ...
      <section className="relative flex min-h-[calc(100vh-60px)] flex-col border-b-[8px] border-foreground bg-[#0c1214] lg:flex-row">
        <div className="absolute left-6 top-6 z-20 lg:left-12">
          <Breadcrumb
            items={[
        ...
        <div className="relative flex flex-col justify-center overflow-hidden px-8 py-16 text-white md:py-24 lg:w-1/2 lg:px-20 lg:py-32">
      ...
      <section className="relative border-b border-border/50 bg-background py-32 md:py-32 lg:py-20 lg:py-48">
        ...
        <div className="container relative mx-auto max-w-[1400px] px-6">
          <motion.div
            ...
            variants={fadeIn}
            className="grid grid-cols-1 items-start gap-16 lg:grid-cols-12 lg:gap-10 lg:gap-24"
          >
            <div className="lg:sticky lg:top-32 lg:col-span-5">
              ...
              <div className="mb-12 hidden h-[4px] w-24 bg-red-500/50 lg:block"></div>
            ...
            <div className="mt-12 flex flex-col gap-12 lg:col-span-7 lg:mt-0">
      ...
      <section className="border-b-[8px] border-foreground bg-background pb-40 pt-32">
              ...
              return (
                ...
                >
                  ...
                  <div className="relative z-10 flex w-full items-center justify-between px-6 py-10 lg:px-12">
                    <div className="flex w-full items-center gap-8 lg:w-2/3 lg:gap-10 lg:gap-16">
                      <span
      ...
      <section className="bg-[#0c1214] py-16 text-white md:py-24 lg:py-32">
        <div className="container mx-auto max-w-[1400px] px-6">
          ...
          <h3 className="mb-20 text-4xl font-black uppercase leading-[0.9] tracking-tighter text-white md:text-6xl">
            Our Approach.
          </h3>
      ...
      <section className="relative border-b-2 border-border/80 bg-background py-16 md:py-24 lg:py-32">
        <div className="container mx-auto max-w-[1400px] px-6">
          <div className="grid grid-cols-1 items-center gap-10 lg:grid-cols-2 lg:gap-20">
            <div>
              ...
              <h3 className="mb-12 text-4xl font-black uppercase leading-[0.9] tracking-tighter md:text-6xl">
                Who This <br /> Is For.
              </h3>
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              className="group relative border-4 border-foreground bg-card p-6 shadow-[16px_16px_0_hsl(var(--forest))] md:p-10 lg:p-16"
            >
      ...
      >
        <div className="relative flex flex-col items-center pt-8 lg:pt-16">
