...
import { AlertCircle, CheckCircle2, ChevronRight, Users, ShieldCheck, Zap, BookOpen } from "lucide-react";
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
            ...
            >
              ...
              <motion.p variants={fadeIn} className="text-xl md:text-2xl text-foreground/90 mb-10 leading-relaxed font-light">
                Enable your teams to build their own reports — without creating chaos. We build Centers of Excellence with governed self-service, certified models, and Fabric guardrails.
              </motion.p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
            ...
            <div className="lg:col-span-5 pl-0 lg:pl-4">
              <div className="sticky top-32">
                <h2 className="text-sm font-bold uppercase tracking-widest text-emerald-400 mb-4 drop-shadow-[0_0_10px_rgba(52,211,153,0.2)]">The Extremes</h2>
                <h3 className="text-4xl md:text-5xl font-bold mb-6 tracking-tight text-foreground">The two paths of failure.</h3>
                <p className="text-xl text-muted-foreground leading-relaxed mb-8">
                  Organizations generally fail at Power BI adoption in one of two ways. Finding the governed middle ground is the defining characteristic of a mature data culture.
                </p>
              </div>
            </div>
            ...
            <div className="lg:col-span-7 flex flex-col gap-8 pt-10">
              ...
              >
                ...
                <h4 className="text-2xl font-bold mb-4 text-foreground">The Wild West (Ungoverned)</h4>
                <p className="text-lg text-muted-foreground leading-relaxed mb-4">You turned Power BI on for everyone. Now you have 4,000 workspaces, 12,000 abandoned reports, and 40 different definitions of "Gross Margin."</p>
                <ul className="space-y-2 text-muted-foreground">
                  <li className="flex items-center gap-2">❌ Duplicate data consuming costly capacity</li>
                  <li className="flex items-center gap-2">❌ No way to know which reports are accurate</li>
                  <li className="flex items-center gap-2">❌ Security risks from unmanaged sharing</li>
                </ul>
              </motion.div>
              ...
              >
                ...
                <h4 className="text-2xl font-bold mb-4 text-foreground">The IT Bottleneck (Over-governed)</h4>
                <p className="text-lg text-muted-foreground leading-relaxed mb-4">IT locked everything down. Every new visual requires a Jira ticket. Every new column requires a two-week sprint cycle. The BI team is drowning in ad-hoc requests.</p>
                <ul className="space-y-2 text-muted-foreground">
                  <li className="flex items-center gap-2">❌ BI team burned out acting as a report factory</li>
                  <li className="flex items-center gap-2">❌ Business users wait weeks for simple answers</li>
                  <li className="flex items-center gap-2">❌ Shadow IT thrives as users export to Excel anyway</li>
                </ul>
              </motion.div>
            </div>
      ...
      <section className="py-32 bg-background relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10 max-w-7xl">
          <div className="text-center mb-20">
            <h2 className="text-sm font-bold uppercase tracking-widest text-emerald-400 mb-4 drop-shadow-[0_0_10px_rgba(52,211,153,0.2)]">Center of Excellence</h2>
            <h3 className="text-4xl md:text-5xl font-bold tracking-tight text-foreground">Governed self-service.</h3>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-6 auto-rows-fr">
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <h4 className="text-3xl font-bold mb-4 text-foreground">Workspace Architecture & Guardrails</h4>
                <p className="text-lg text-muted-foreground leading-relaxed max-w-2xl">
                  Fabric workspace design separating data layers (medallion architecture) from reporting layers. We implement strict naming conventions, access policies via security groups, and governed app deployment strategies.
                </p>
              </div>
            </motion.div>
            ...
            >
               <div className="relative z-10">
                ...
                <h4 className="text-2xl font-bold mb-4 text-foreground">Endorsement Framework</h4>
                <p className="text-muted-foreground leading-relaxed">
                  Clear, enforced processes for how a report graduates from personal workspace sandbox ➔ Promoted team report ➔ Certified enterprise dashboard.
                </p>
              </div>
            </motion.div>
            ...
            >
               <div className="relative z-10">
                ...
                <h4 className="text-2xl font-bold mb-4 text-foreground">CoE Charter Definition</h4>
                <p className="text-muted-foreground leading-relaxed">
                  Defined roles (Data Owners, Stewards, Creators), established support escalation paths, and defined monthly governance review routines.
                </p>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <h4 className="text-3xl font-bold mb-4 text-foreground">Analyst Enablement Program</h4>
                <p className="text-lg text-muted-foreground leading-relaxed max-w-2xl">
                  Custom curriculum and hands-on training for your business users. We don't teach generic Power BI tutorials; we teach 'How to build reports connecting to OUR certified semantic models' using your actual data.
                </p>
              </div>
            </motion.div>
          </div>
      ...
      <section className="py-32 bg-muted/20 relative overflow-hidden">
        <div className="container mx-auto px-6 max-w-6xl">
          <div className="text-center mb-16">
            ...
            <h3 className="text-4xl md:text-5xl font-bold tracking-tight text-foreground mb-4">How we deploy a CoE</h3>
          ...
          <div className="bg-primary/5 text-foreground rounded-[3rem] p-10 md:p-16 relative overflow-hidden shadow-sm border border-primary/20">
            ...
            <div className="relative z-10">
              ...
              <h2 className="text-3xl md:text-5xl font-bold mb-12 max-w-3xl leading-tight text-foreground">
                70% reduction in IT reporting backlog through governed self-service.
              </h2>
              ...
              <div className="grid md:grid-cols-2 gap-12">
                <div>
                  ...
                  <p className="text-muted-foreground leading-relaxed text-lg">
                    A global manufacturer had a 6-month backlog for new reporting requests. The core BI team of 4 people spent all their time tweaking visual formatting or adding single columns to existing reports. Meanwhile, business analysts were frustrated and reverting to manual Excel dumps to bypass IT entirely.
                  </p>
                </div>
                <div>
                  ...
                  <ul className="space-y-3 text-muted-foreground text-lg">
                    <li className="flex items-start gap-3">
                      ...
                      "Hub & Spoke" Architecture allowing users to build reports (Spokes) connected live to certified datasets (Hubs).
                    </li>
                    <li className="flex items-start gap-3">
                      <div className="w-1.5 h-1.5 rounded-full bg-primary mt-2.5 shrink-0" />
                      "Dashboard in a Day" Custom Training utilizing the manufacturer's actual production data.
                    </li>
                    <li className="flex items-start gap-3">
                      <div className="w-1.5 h-1.5 rounded-full bg-primary mt-2.5 shrink-0" />
                      Established a CoE Teams Channel for peer-to-peer tier-1 support.
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <div className="mt-16 pt-10 border-t border-primary/20 grid grid-cols-1 sm:grid-cols-3 gap-8">
                <div>
                  ...
                  <p className="text-muted-foreground font-medium">Analysts empowered</p>
                </div>
                <div>
                  <p className="text-4xl font-black text-primary mb-2 mt-1">70%</p>
                  <p className="text-muted-foreground font-medium">Reduction in IT Backlog</p>
                </div>
                <div className="flex flex-col justify-end">
                   <Link href="/industries/manufacturing" className="text-primary hover:text-primary/80 transition-colors font-bold flex items-center gap-2 group text-lg">
      ...
      <section className="py-24 bg-background">
        <div className="container mx-auto px-6 max-w-5xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <Link href="/services/decision-intelligence/semantic-modeling" className="group">
              <div className="p-8 bg-muted/20 backdrop-blur-sm rounded-[2rem] border border-border/60 hover:border-primary/40 transition-all duration-300 shadow-sm hover:shadow-md h-full flex flex-col justify-between">
                <h3 className="text-xl font-bold mb-2 group-hover:text-primary transition-colors tracking-tight">Semantic Modeling</h3>
            ...
            <Link href="/services/define-your-roadmap/enterprise-data-strategy" className="group">
              <div className="p-8 bg-muted/20 backdrop-blur-sm rounded-[2rem] border border-border/60 hover:border-primary/40 transition-all duration-300 shadow-sm hover:shadow-md h-full flex flex-col justify-between">
                <h3 className="text-xl font-bold mb-2 group-hover:text-primary transition-colors tracking-tight">Enterprise Data Strategy</h3>
                <span className="text-primary font-bold flex items-center gap-2 text-sm mt-4 uppercase tracking-wider">Learn more <ChevronRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" /></span>
              </div>
            </Link>
            <Link href="/services/build-your-foundation/data-integration" className="group">
              <div className="p-8 bg-muted/20 backdrop-blur-sm rounded-[2rem] border border-border/60 hover:border-primary/40 transition-all duration-300 shadow-sm hover:shadow-md h-full flex flex-col justify-between">
                <h3 className="text-xl font-bold mb-2 group-hover:text-primary transition-colors tracking-tight">Data Integration</h3>
                <span className="text-primary font-bold flex items-center gap-2 text-sm mt-4 uppercase tracking-wider">Learn more <ChevronRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" /></span>
              </div>
            </Link>
          </div>
      ...
      <section className="py-24 bg-background border-t border-border">
        <div className="container mx-auto px-6 max-w-5xl">
          <div className="bg-primary/5 border border-primary/20 rounded-[3rem] p-12 md:p-16 text-center shadow-lg shadow-primary/5">
            <h2 className="text-4xl md:text-5xl font-bold mb-6 tracking-tight">Empower analysts, protect data.</h2>
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto mb-10 leading-relaxed">
              Stop being the IT bottleneck. Let's build a Center of Excellence that scales analytics securely across your organization.
            </p>
            <Link href="/contact?service=self-service" passHref>
