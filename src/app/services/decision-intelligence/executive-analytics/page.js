...
import { AlertCircle, CheckCircle2, ChevronRight, BarChart3, LineChart, PieChart, TrendingUp, Presentation } from "lucide-react";
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
            ...
            >
              ...
              <motion.p variants={fadeIn} className="text-xl md:text-2xl text-foreground/90 mb-10 leading-relaxed font-light">
                Stop looking at 40 different charts to find the truth. We build high-signal, zero-noise Power BI dashboards designed specifically for the C-Suite and Board of Directors.
              </motion.p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
            ...
            <div className="lg:col-span-5 pl-0 lg:pl-4">
              <div className="sticky top-32">
                ...
                <h3 className="text-4xl md:text-5xl font-bold mb-6 tracking-tight text-foreground">Data rich, insight poor.</h3>
                <p className="text-xl text-muted-foreground leading-relaxed mb-8">
                  Most executive dashboards fail because they are designed by analysts, not executives. They answer "what happened" instead of "what requires my attention right now."
                </p>
              </div>
            </div>
            ...
            <div className="lg:col-span-7 flex flex-col gap-8 pt-10">
              ...
              >
                ...
                <h4 className="text-2xl font-bold mb-4 text-foreground">The Cognitive Overload Screen</h4>
                <p className="text-lg text-muted-foreground leading-relaxed">Your dashboard has 14 different visuals, 8 slicers, and a matrix table with 40 columns. It takes an executive 5 minutes just to figure out what they are looking at. When everything is highlighted, nothing is important.</p>
              </motion.div>
              ...
              >
                ...
                <h4 className="text-2xl font-bold mb-4 text-foreground">Numbers Without Context</h4>
                <p className="text-lg text-muted-foreground leading-relaxed">The giant KPI card says "$4.2M Revenue." Is that good? Bad? Are we ahead of plan? Are we losing to a competitor? Showing a number without comparing it to a target, forecast, or historical benchmark renders it meaningless.</p>
              </motion.div>
              ...
              >
                ...
                <h4 className="text-2xl font-bold mb-4 text-foreground">The Frankenstein Board Deck</h4>
                <p className="text-lg text-muted-foreground leading-relaxed">You have thousands of dollars invested in Power BI licenses, but your analysts still spend 3 days before every board meeting copying screenshots into PowerPoint because the actual dashboards "don't look right for the board."</p>
              </motion.div>
            </div>
      ...
      <section className="py-32 bg-background relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10 max-w-7xl">
          <div className="text-center mb-20">
            ...
            <h3 className="text-4xl md:text-5xl font-bold tracking-tight text-foreground">Actionable intelligence.</h3>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-6 auto-rows-fr">
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <h4 className="text-3xl font-bold mb-4 text-foreground">The "One-Pager" Executive Summary</h4>
                <p className="text-lg text-muted-foreground leading-relaxed max-w-2xl">
                  A high-level landing page utilizing IBCS (International Business Communication Standards). Clean, consistent visuals that instantly show performance vs. target, year-over-year growth, and top-tier KPIs.
                </p>
              </div>
            </motion.div>
            ...
            >
               <div className="relative z-10">
                ...
                <h4 className="text-2xl font-bold mb-4 text-foreground">Board Reporting Packages</h4>
                <p className="text-muted-foreground leading-relaxed">
                  Power BI reports designed specifically for export to PowerPoint and PDF, perfectly formatted for your board presentation templates.
                </p>
              </div>
            </motion.div>
            ...
            >
               <div className="relative z-10">
                ...
                <h4 className="text-2xl font-bold mb-4 text-foreground">Automated Narratives</h4>
                <p className="text-muted-foreground leading-relaxed">
                  Smart Narrative visuals that auto-generate text summaries of the data. Executives read sentences first, view charts second.
                </p>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <h4 className="text-3xl font-bold mb-4 text-foreground">Deep Dive Capabilities</h4>
                <p className="text-lg text-muted-foreground leading-relaxed max-w-2xl">
                  Drill-through actions configured so an executive can click a red KPI and instantly jump to the operational level to see the "why" — without switching reports or logging into another system.
                </p>
              </div>
            </motion.div>
          </div>
      ...
      <section className="py-32 bg-muted/20 relative overflow-hidden">
        <div className="container mx-auto px-6 max-w-6xl">
          <div className="text-center mb-16">
            ...
            <h3 className="text-4xl md:text-5xl font-bold tracking-tight text-foreground mb-4">How we build for leaders.</h3>
          ...
          <div className="bg-primary/5 text-foreground rounded-[3rem] p-10 md:p-16 relative overflow-hidden shadow-sm border border-primary/20">
            ...
            <div className="relative z-10">
              ...
              <div className="grid md:grid-cols-2 gap-12">
                <div>
                  ...
                  <p className="text-muted-foreground leading-relaxed text-lg">
                    The CFO and FP&A team spent 5 full days every month compiling a 40-page PDF for the board. The data came from 6 different systems. During meetings, if a board member asked a question not covered in the static PDF (e.g., "What was the margin on Product Line B in Germany?"), the CFO had to say "I'll get back to you next week."
                  </p>
                </div>
                <div>
                  ...
                  <ul className="space-y-3 text-muted-foreground text-lg">
                    <li className="flex items-start gap-3">
                      ...
                      An Executive application housing Revenue, Cost to Serve, and OPEX.
                    </li>
                    <li className="flex items-start gap-3">
                      <div className="w-1.5 h-1.5 rounded-full bg-primary mt-2.5 shrink-0" />
                      Paginated Report integration for pixel-perfect PDF exports that matched old templates.
                    </li>
                    <li className="flex items-start gap-3">
                      <div className="w-1.5 h-1.5 rounded-full bg-primary mt-2.5 shrink-0" />
                      Drill-through functionality allowing the CFO to answer ad-hoc questions live during the board meeting.
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <div className="mt-16 pt-10 border-t border-primary/20 grid grid-cols-1 sm:grid-cols-3 gap-8">
                <div>
                  <p className="text-5xl font-black text-primary mb-2">5 Days</p>
                  <p className="text-muted-foreground font-medium">Monthly time saved</p>
                </div>
                <div>
                  <p className="text-4xl font-black text-primary mb-2 mt-1">1 App</p>
                  <p className="text-muted-foreground font-medium">Replaced 40 pages</p>
                </div>
                <div className="flex flex-col justify-end">
                   <Link href="/industries/healthcare-lifesciences" className="text-primary hover:text-primary/80 transition-colors font-bold flex items-center gap-2 group text-lg">
                    See Healthcare Work
      ...
      <section className="py-24 bg-background border-t border-border">
        <div className="container mx-auto px-6 max-w-5xl">
          <div className="bg-primary/5 border border-primary/20 rounded-[3rem] p-12 md:p-16 text-center shadow-lg shadow-primary/5">
            <h2 className="text-4xl md:text-5xl font-bold mb-6 tracking-tight">See clearly. Act decisively.</h2>
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto mb-10 leading-relaxed">
              Stop digging through complex reports to find basic answers. Provide your leadership with zero-friction clarity.
            </p>
            <Link href="/contact?service=executive-analytics" passHref>
