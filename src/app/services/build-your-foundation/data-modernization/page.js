...
export default function DataModernization() {
 ...
 className="border-[3px] md:border-[4px] border-foreground bg-card shadow-[8px_8px_0px_0px_hsl(var(--emerald-600)/0.2)] md:shadow-[20px_20px_0px_0px_hsl(var(--emerald-600)/0.2)]"
 >
 {/* Top Header Row */}
 <div className="border-b-[3px] md:border-b-[4px] border-foreground grid grid-cols-1 md:grid-cols-3 bg-muted/30">
 ...
 className="text-[2.25rem] sm:text-[3.5rem] md:text-[5rem] lg:text-[6rem] font-black uppercase leading-[0.85] tracking-tighter text-foreground mb-8 sm:mb-10 relative z-10"
 >
 ...
 className="max-w-2xl text-xl sm:text-2xl font-bold leading-snug text-foreground mb-6 lg:mb-8 border-l-[4px] border-emerald-600 pl-6 relative z-10 bg-gradient-to-r from-emerald-500/5 to-transparent py-2"
 >
 ...
 <section className="overflow-x-clip relative z-30 bg-muted/20 pb-8 lg:pb-12 pt-8 lg:pt-12">
 <div className="absolute inset-0 bg-[linear-gradient(to_right,#80808008_1px,transparent_1px),linear-gradient(to_bottom,#80808008_1px,transparent_1px)] bg-[size:24px_24px]"></div>
 
 <div className="container relative z-10 mx-auto max-w-7xl px-4 sm:px-6">
 <div className="mb-6 lg:mb-8 sm:mb-6 lg:mb-8 border-l-8 border-emerald-600 bg-card p-6 sm:p-8 shadow-[8px_8px_0px_0px_rgba(0,0,0,0.05)] md:shadow-[15px_15px_0px_0px_rgba(0,0,0,0.05)] md:w-5/6 lg:w-2/3">
 <h2 className="mb-3 sm:mb-4 flex items-center gap-3 sm:gap-4 text-xs sm:text-sm font-black uppercase tracking-[0.2em] sm:tracking-[0.3em] text-emerald-600">
 <span className="h-1 w-8 sm:w-12 bg-emerald-600"></span>
 The Reality Check
 </h2>
 <h3 className="text-[2.25rem] sm:text-[3rem] font-black uppercase leading-[0.85] tracking-tighter text-foreground md:text-[4rem]">
 ...
 <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-100px" }} variants={fadeIn}
 className="group relative bg-card border-t-4 border-indigo-500 p-8 shadow-xl transition-transform hover:-translate-y-2 lg:mt-8 lg:mt-12"
 >
 ...
 <section className="overflow-x-clip relative border-y-[8px] border-foreground bg-background py-16 lg:py-24 lg:py-16 lg:py-24">
 <div className="container mx-auto max-w-[1400px] px-6">
 <div className="mb-6 lg:mb-8 flex flex-col justify-between gap-8 border-b-4 border-emerald-600 pb-8 md:flex-row md:items-end">
 ...
 <div className="grid grid-cols-1 gap-[2px] border-[3px] border-foreground bg-foreground p-[2px] shadow-[8px_8px_0px_0px_hsl(var(--emerald-600)/0.3)] md:shadow-[20px_20px_0px_0px_hsl(var(--emerald-600)/0.3)] md:grid-cols-2 lg:grid-cols-4">
 
 {/* Cell 1: 2-columns wide */}
 <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeIn}
 className="group relative col-span-1 flex min-h-[350px] flex-col justify-between overflow-hidden bg-card p-8 md:col-span-2 lg:p-6 lg:p-8"
 >
 <div className="relative z-10 mb-6 lg:mb-8 flex items-start justify-between">
 ...
 {/* Cell 2 */}
 <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeIn}
 className="group relative flex min-h-[350px] flex-col justify-between bg-card p-8 lg:p-6 lg:p-8"
 >
 <div className="relative z-10 mb-6 lg:mb-8 flex items-start justify-between">
 ...
 {/* Cell 4: Full width */}
 <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeIn}
 className="group relative col-span-1 flex flex-col items-center justify-between gap-12 lg:gap-16 overflow-hidden bg-foreground p-8 text-background md:col-span-2 lg:col-span-4 lg:flex-row lg:p-6 lg:p-8"
 >
 <div className="relative z-10 max-w-4xl">
 <div className="mb-8 flex items-center gap-6">
 <ShieldCheck className="h-14 w-14 text-emerald-400" />
 </div>
 <h4 className="mb-6 sm:mb-8 text-[1.75rem] sm:text-[2rem] font-black uppercase leading-[0.85] tracking-tight text-background lg:text-[4rem]">
 ...
 {/* Case Study Section */}
 <section className="relative overflow-x-clip bg-muted/20 pb-8 lg:pb-12 pt-8 lg:pt-12 sm:pb-8 lg:pb-12 sm:pt-8 lg:pt-12">
 ...
 <div className="relative overflow-hidden border-[6px] border-foreground bg-black ">
 <Image
 ...
 <div className="relative z-20 mx-auto -mt-8 lg:mt-12 w-[95%] min-w-0 max-w-lg border-[3px] border-foreground bg-card/95 p-6 shadow-[8px_8px_0px_0px_hsl(var(--emerald-600))] md:shadow-[10px_10px_0px_0px_hsl(var(--emerald-600))] backdrop-blur-2xl sm:-mt-8 lg:mt-12 sm:w-[95%] sm:border-4 sm:p-6 lg:p-8 lg:col-span-6 lg:col-start-7 lg:row-start-1 lg:mx-0 lg:mt-8 lg:mt-12 lg:w-auto lg:max-w-none lg:self-start lg:p-6 lg:p-8">
 ...
 <h2 className="mb-6 sm:mb-8 text-[2rem] sm:text-3xl font-black uppercase leading-[0.95] tracking-tight text-foreground md:text-5xl">
 ...
 {/* CTA Section */}
 <section className="overflow-x-clip bg-foreground py-16 lg:py-24 sm:py-16 lg:py-24 text-background lg:py-16 lg:py-24">
 <div className="container mx-auto max-w-4xl px-4 sm:px-6 text-center">
 <h2 className="mb-6 sm:mb-8 text-[2.25rem] font-black uppercase leading-[0.9] tracking-tighter sm:text-[4rem] md:text-[5rem]">
 Leave Legacy Behind.
 </h2>
