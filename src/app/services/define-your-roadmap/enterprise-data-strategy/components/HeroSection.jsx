...
import { ChevronRight, Users, Flag, Route } from "lucide-react";
...
export default function HeroSection() {
 ...
 <Users className="h-5 w-5 sm:h-6 sm:w-6 text-[#1b2b36]" />
 ...
 <div className="flex flex-col gap-1 sm:gap-2">
 <Flag className="h-5 w-5 sm:h-6 sm:w-6 text-[#1b2b36]" />
 ...
 <div className="flex flex-col gap-1 sm:gap-2">
 <Route className="h-5 w-5 sm:h-6 sm:w-6 text-[#1b2b36]" />
