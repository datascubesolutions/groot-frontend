...
export default function StackEvaluationPageClient() {
 return (
 <main className="relative min-h-screen overflow-x-hidden bg-background pt-16 md:pt-20 selection:bg-cyan-500/30">
 <HeroSection />
 ...
 <div className="mb-8 lg:mb-10 border-l-8 border-cyan-500 bg-card p-6 lg:p-8 shadow-[8px_8px_0px_0px_rgba(0,0,0,0.05)] md:shadow-[15px_15px_0px_0px_rgba(0,0,0,0.05)] md:w-3/4 lg:w-2/3 xl:w-[60%]">
 ...
 <div className="grid gap-12 lg:gap-16 xl:gap-12 lg:gap-16 lg:grid-cols-2 items-start max-w-5xl">
 ...
 <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-100px" }} variants={fadeIn}
 className="group relative bg-card border-t-4 border-amber-500 p-6 xl:p-8 shadow-xl transition-transform hover:-translate-y-2 lg:mt-8 lg:mt-12 flex flex-col overflow-hidden"
 >
 ...
 viewport={{ once: true }}
 variants={fadeIn}
 className="group relative flex min-h-[280px] flex-col overflow-hidden bg-card p-6 md:p-8 transition-colors duration-500 hover:bg-blue-50 "
 >
 ...
 viewport={{ once: true }}
 variants={fadeIn}
 className="group relative flex min-h-[280px] flex-col overflow-hidden bg-card p-6 md:p-8 transition-colors duration-500 hover:bg-orange-50 "
 >
 <div className="relative z-10 mb-8 flex items-start justify-between">
 <Braces
 ...
 viewport={{ once: true }}
 variants={fadeIn}
 className="group relative flex min-h-[280px] flex-col overflow-hidden bg-card p-6 md:p-8 transition-colors duration-500 hover:bg-cyan-50 "
 >
 <div className="relative z-10 mb-8 flex items-start justify-between">
 <ServerCog
