...
const STYLES = {
  panelCard:
    "flex-1 relative bg-card overflow-hidden group hover:-translate-y-2 hover:z-10 transition-transform duration-500 flex flex-col p-8 md:p-10 min-h-[350px] border border-border",
  panelHoverLine:
  ...
  headerWrapper:
    "mb-16 flex flex-col md:flex-row md:items-end justify-between gap-8 border-b-4 border-cyan-600 pb-8",
  ...
  gridOuter:
    "flex flex-col lg:flex-row gap-[3px] border-[4px] border-foreground bg-foreground p-1 shadow-[20px_20px_0px_0px_rgba(6,182,212,0.3)]",
};
