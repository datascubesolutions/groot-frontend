...
const STYLES = {
  ...
  cardOuter:
    "bg-card border border-border p-10 md:p-14 rounded-[3rem] shadow-[0_20px_60px_-15px_rgba(0,0,0,0.05)] relative overflow-hidden group hover:border-cyan-500/20 transition-all duration-700",
  cardBgGlow:
