...
const STYLES = {
 section:
 "py-16 lg:py-24 md:py-16 lg:py-24 bg-[#040404] text-white overflow-hidden relative border-y border-white/10",
 bgGlow:
 ...
 headerWrapper:
 "flex flex-col items-center text-center mb-6 lg:mb-8 max-w-3xl mx-auto",
 ...
 grid: "grid grid-cols-1 md:grid-cols-3 gap-12 lg:gap-16",
 cardOuter:
 "bg-white/[0.03] border border-white/10 rounded-[2rem] p-8 md:p-6 lg:p-8 hover:bg-white/[0.05] transition-colors duration-500 group flex flex-col pt-12 relative overflow-hidden",
 bgIconWrapper:
