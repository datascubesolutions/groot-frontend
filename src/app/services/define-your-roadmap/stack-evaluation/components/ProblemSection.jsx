...
const STYLES = {
  ...
  leftColumn:
    "md:w-[35%] md:sticky top-32 z-40 flex flex-col gap-6 -mt-16 ml-0 md:ml-4",
  heroCard:
    "bg-card/95 backdrop-blur-xl p-8 lg:p-10 border-l-[12px] border-y border-r border-cyan-500 shadow-[30px_30px_60px_-15px_rgba(6,182,212,0.15)] rounded-tr-[4rem] rounded-bl-[4rem]",
  badgeWrapper:
  ...
  pCardWrapper1:
    "relative bg-card border-2 border-border p-8 lg:p-12 shadow-xl z-10 w-full md:w-[90%] hover:scale-[1.02] hover:border-cyan-500/30 transition-all duration-500 overflow-hidden group rounded-tl-[3rem] rounded-br-[3rem]",
  pCardBgText1:
  ...
  pCardWrapper2:
    "relative bg-foreground text-background p-8 lg:p-12 shadow-[0_-20px_50px_-15px_rgba(0,0,0,0.5)] z-20 w-full md:w-[95%] self-end mt-6 sm:-mt-6 lg:-mt-12 hover:scale-[1.02] transition-transform duration-500 overflow-hidden group rounded-tr-[3rem] rounded-bl-[3rem]",
  pCardBgText2:
