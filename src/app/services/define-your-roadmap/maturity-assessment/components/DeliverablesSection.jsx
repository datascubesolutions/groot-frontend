...
export default function DeliverablesSection() {
 return (
 <section className="overflow-x-clip relative border-b-2 border-t-[8px] border-foreground bg-muted/20 py-16 lg:py-24 lg:py-16 lg:py-24">
 <div className="absolute inset-0 bg-[linear-gradient(to_right,#80808012_1px,transparent_1px),linear-gradient(to_bottom,#80808012_1px,transparent_1px)] bg-[size:40px_40px]" />

 <div className="container relative z-10 mx-auto max-w-[1400px] px-6">
 <div className="mb-6 lg:mb-8 flex flex-col justify-between gap-8 border-b-4 border-forest pb-8 md:flex-row md:items-end">
 ...
 viewport={{ once: true }}
 variants={fadeIn}
 className="group relative col-span-1 flex min-h-[300px] flex-col justify-between overflow-hidden bg-card p-6 transition-colors duration-500 hover:bg-forest/5 sm:min-h-[350px] sm:p-8 md:col-span-2 lg:p-6 lg:p-8"
 >
 ...
 viewport={{ once: true }}
 variants={fadeIn}
 className="group relative flex min-h-[300px] flex-col justify-between bg-card p-6 transition-colors duration-500 hover:bg-cyan-500/5 sm:min-h-[350px] sm:p-8 lg:p-6 lg:p-8"
 >
 <div className="relative z-10 mb-6 lg:mb-8 flex items-start justify-between">
 <Target
 ...
 viewport={{ once: true }}
 variants={fadeIn}
 className="group relative flex min-h-[300px] flex-col justify-between bg-card p-6 transition-colors duration-500 hover:bg-blue-500/5 sm:min-h-[350px] sm:p-8 lg:p-6 lg:p-8"
 >
 <div className="relative z-10 mb-6 lg:mb-8 flex items-start justify-between">
 <ShieldCheck
 ...
 viewport={{ once: true }}
 variants={fadeIn}
 className="group relative col-span-1 flex flex-col items-center justify-between gap-12 lg:gap-16 overflow-hidden bg-foreground p-8 text-background sm:p-6 lg:p-8 md:col-span-2 md:flex-row lg:col-span-4 lg:p-6 lg:p-8 lg:px-6"
 >
