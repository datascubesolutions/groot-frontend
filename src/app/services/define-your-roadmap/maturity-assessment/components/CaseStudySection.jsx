...
export default function CaseStudySection() {
 return (
 <section className="relative flex flex-col justify-center border-t-2 border-b-2 border-foreground bg-background py-20 lg:py-0 overflow-hidden">
 {/* Background Grid */}
 ...
 {/* 2x2 Grid Block */}
 <div className="flex-1 min-h-[50vh] bg-foreground border-[3px] border-foreground p-[2px] shadow-[8px_8px_0px_0px_hsl(var(--emerald-600)/0.25)] md:shadow-[15px_15px_0px_0px_hsl(var(--emerald-600)/0.25)] flex flex-col mb-2">
 <div className="grid grid-cols-1 lg:grid-cols-2 gap-[2px] h-full flex-1">
 
 {/* Cell 1: Situation */}
 <div className="group relative bg-card p-6 md:p-8 lg:p-6 lg:p-8 flex flex-col overflow-hidden justify-center">
 ...
 <span className="text-[13px] font-bold text-[#1b2b36] leading-snug block">AAS models well-designed, but platform reaching limits. No autoscaling.</span>
 </div>
 <div className="bg-slate-50/80 p-4 rounded-md border border-slate-200 shadow-sm">
 <strong className="text-blue-700 uppercase text-[11px] tracking-widest block mb-1.5">Analytics</strong> 
 <span className="text-[13px] font-bold text-[#1b2b36] leading-snug block">Disconnected from modern Power BI Premium features like dataflows.</span>
 </div>
 <div className="bg-slate-50/80 p-4 rounded-md border border-slate-200 shadow-sm">
 <strong className="text-blue-700 uppercase text-[11px] tracking-widest block mb-1.5">Governance</strong> 
 <span className="text-[13px] font-bold text-[#1b2b36] leading-snug block">No Purview. No lineage. Sensitive data without classification.</span>
 </div>
 <div className="bg-slate-50/80 p-4 rounded-md border border-slate-200 shadow-sm">
 <strong className="text-blue-700 uppercase text-[11px] tracking-widest block mb-1.5">Organization</strong> 
 <span className="text-[13px] font-bold text-[#1b2b36] leading-snug block">One senior developer maintained everything. Knowledge trapped.</span>
 </div>
 </div>
 </div>

 {/* Cell 3: Recommendation (Dark Block) */}
 <div className="group relative bg-[#0A2518] p-6 md:p-8 lg:p-6 lg:p-8 flex flex-col text-background overflow-hidden justify-center">
 ...
 <div className="text-[11px] font-bold uppercase tracking-widest text-slate-700 mt-2">Faster Refresh</div>
 </div>
 ...
 <div className="text-[11px] font-bold uppercase tracking-widest text-slate-700 mt-2">To Migrate</div>
 </div>
 </div>
