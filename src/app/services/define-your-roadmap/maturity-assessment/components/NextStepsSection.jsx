...
export default function NextStepsSection({
 ...
 className="flex flex-col lg:flex-row items-center justify-center gap-12 lg:gap-16 lg:gap-12 lg:gap-16"
 >
 {/* Left Column - Mockup */}
 ...
 <div className="relative w-full lg:w-[55%] rounded-[2.5rem] border border-white/80 bg-white/95 p-8 shadow-[0_16px_60px_rgba(0,0,0,0.04)] backdrop-blur-xl sm:p-6 lg:p-8 md:p-6 lg:p-8 lg:p-6 lg:p-8">
 <h2 className="mb-2 font-serif text-[2.5rem] font-bold leading-[1.05] tracking-tight text-[#1b2b36] sm:text-5xl lg:text-[3.25rem]">
 {headline}
 </h2>
 <h3 className="mb-6 text-[1.1rem] font-medium tracking-tight text-[#1b2b36] sm:text-[1.25rem]">
 {subHeadline}
 </h3>
 ...
 <p className="text-[1.15rem] font-serif italic text-[#1b2b36] leading-snug">
 {resolvedTagline}
 </p>
 </div>
 </div>
 ...
 <span className="text-[10px] font-medium italic text-slate-500 mb-0.5 text-left"></span>
 </div>
