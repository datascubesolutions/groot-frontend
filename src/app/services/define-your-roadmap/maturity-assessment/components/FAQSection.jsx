...
export default function FAQSection() {
 return (
 <section className="relative overflow-hidden border-t-2 border-border/60 bg-muted/40 py-16 lg:py-24 lg:py-16 lg:py-24">
 <div className="pointer-events-none absolute right-0 top-0 w-[500px] max-w-full rounded-none bg-forest/5 blur-[100px]" />
 <div className="container relative z-10 mx-auto max-w-5xl px-6">
 <div className="mb-6 lg:mb-8 border-b-4 border-foreground pb-8">
