...
function MethodPanel({ step, week, title, desc, color }) {
 ...
 <div className="relative z-10 flex flex-1 flex-col p-6 transition-transform duration-500 group-hover/panel:-translate-y-2 md:p-6 lg:p-8">
...
export default function MethodologySection() {
 ...
 <div className="mb-6 lg:mb-8 flex flex-col justify-between gap-8 border-b-8 border-foreground pb-12 md:flex-row md:items-center md:gap-10">
