...
export default function DefineYourRoadmap() {
 ...
 <section className="overflow-x-clip relative pb-8 lg:pb-12 pt-10 lg:pb-48">
 <div
 ...
 <motion.h1
 variants={fadeIn}
 className="mb-6 lg:mb-8 text-[3rem] font-black uppercase leading-[0.8] tracking-tighter text-foreground drop-shadow-[5px_5px_0_hsl(var(--forest)/0.1)] sm:text-[4rem] md:text-[6rem] lg:text-[7.5rem]"
 >
 ...
 <motion.div
 variants={fadeIn}
 className="relative z-30 -ml-4 border-[4px] border-foreground bg-background/95 p-6 shadow-[6px_6px_0_0_hsl(var(--forest))] md:shadow-[10px_10px_0_0_hsl(var(--forest))] backdrop-blur-2xl md:-ml-8 md:p-6 lg:p-8 md:shadow-[20px_20px_0_0_hsl(var(--forest))]"
 >
 ...
 variant="hero"
 size="lg"
 className="group flex h-20 w-full items-center justify-between whitespace-normal rounded-none border-[3px] border-foreground bg-foreground px-4 text-left text-xs font-black uppercase tracking-widest text-background shadow-[6px_6px_0px_0px_hsl(var(--forest)/0.4)] md:shadow-[10px_10px_0px_0px_hsl(var(--forest)/0.4)] transition-all duration-500 hover:translate-x-[10px] hover:translate-y-[10px] hover:bg-forest hover:text-forest-foreground hover:shadow-none sm:whitespace-nowrap sm:px-10 sm:text-center sm:text-sm sm:tracking-[0.2em] md:text-base"
 >
 ...
 variant="outline"
 size="lg"
 className="flex h-20 w-full items-center justify-center gap-3 whitespace-normal rounded-none border-[3px] border-foreground bg-transparent px-4 text-center text-xs font-black uppercase tracking-widest text-foreground shadow-[6px_6px_0px_0px_hsl(var(--foreground)/0.1)] md:shadow-[10px_10px_0px_0px_hsl(var(--foreground)/0.1)] transition-all duration-500 hover:translate-x-[10px] hover:translate-y-[10px] hover:bg-muted hover:shadow-none sm:whitespace-nowrap sm:px-10 sm:text-sm sm:tracking-[0.2em] md:text-base"
 >
 Talk to Our Team
 </Button>
 </Link>
 ...
 className="group relative mt-8 lg:mt-12 h-[450px] overflow-hidden border-[6px] border-foreground bg-muted/20 lg:col-span-5 lg:mt-0 lg:h-[700px]"
 >
 ...
 <div className="absolute bottom-10 right-10 flex flex-col gap-3 border-[4px] border-foreground bg-background p-5 text-foreground shadow-[6px_6px_0_0_hsl(var(--forest))] md:shadow-[10px_10px_0_0_hsl(var(--forest))]">
 ...
 <section className="overflow-x-clip relative z-30 bg-background pb-48 pt-8 lg:pt-12"
 ref={targetRef}
 >
 <div className="container mx-auto max-w-7xl px-6">
 <div className="flex flex-col items-start gap-12 lg:gap-16 lg:flex-row lg:gap-32">
 {/* Sticky Sidebar */}
 <div className="top-32 z-40 -mt-8 border-[4px] border-l-[12px] border-foreground border-l-forest bg-card p-6 shadow-[15px_15px_0_0_hsl(var(--forest)/0.2)] sm:-mt-8 lg:mt-12 md:sticky md:p-6 lg:p-8 md:shadow-[30px_30px_0_0_hsl(var(--forest)/0.2)] lg:-mt-8 lg:mt-12 lg:w-[40%] lg:p-6 lg:p-8">
 ...
 <div className="flex flex-col gap-10 pt-10 lg:w-[60%] lg:gap-12 lg:gap-16">
 {/* Problem 01 */}
 <motion.div
 initial="hidden"
 whileInView="visible"
 ...
 variants={fadeIn}
 className="group relative isolate overflow-hidden border-x-4 border-y border-foreground bg-card p-6 shadow-[6px_6px_0_0_hsl(var(--forest)/0.1)] md:shadow-[10px_10px_0_0_hsl(var(--forest)/0.1)] md:p-6 lg:p-8 lg:p-6 lg:p-8 lg:shadow-[20px_20px_0_0_hsl(var(--forest)/0.1)]"
 >
 ...
 viewport={{ once: true, margin: "-100px" }}
 variants={fadeIn}
 className="group relative isolate self-end overflow-hidden bg-foreground p-6 text-background shadow-[15px_15px_0_0_hsl(var(--forest)/0.3)] md:w-[90%] md:p-6 lg:p-8 lg:p-6 lg:p-8 lg:shadow-[30px_30px_0_0_hsl(var(--forest)/0.3)]"
 >
 ...
 <section className="overflow-x-clip relative border-b-2 border-t-[8px] border-foreground bg-muted/30 py-16 lg:py-24 md:py-16 lg:py-24 lg:py-16 lg:py-24">
 <div className="absolute inset-0 bg-[linear-gradient(to_right,#80808012_1px,transparent_1px),linear-gradient(to_bottom,#80808012_1px,transparent_1px)] bg-[size:40px_40px]" />

 <div className="container relative z-10 mx-auto max-w-[1400px] px-6">
 <div className="mb-24 flex flex-col justify-between gap-12 lg:gap-16 border-b-[6px] border-forest pb-10 md:flex-row md:items-end">
 ...
 Two specific assessments to document your current state and
 design your target architecture.
 </p>
 </div>

 <div className="grid grid-cols-1 gap-[4px] border-[4px] border-foreground bg-foreground p-[4px] shadow-[25px_25px_0_0_hsl(var(--forest)/0.25)] md:grid-cols-2">
 <SubServiceCard
 itemNum="A."
 ...
 */}
 ...
 <div className="container mx-auto max-w-7xl px-6">
 <div className="mb-6 lg:mb-8 flex flex-col justify-between gap-8 border-b-[10px] border-foreground pb-12 md:flex-row md:items-end lg:mb-24 lg:gap-12 lg:gap-16 lg:pb-8 lg:pb-12">
 ...
 <section className="overflow-x-clip relative border-y-[6px] border-foreground bg-muted/40 py-16 lg:py-24 md:py-16 lg:py-24 lg:py-16 lg:py-24">
 <div className="container mx-auto max-w-[1400px] px-6">
 <div className="grid grid-cols-1 items-start gap-24 lg:grid-cols-12 lg:gap-10 lg:gap-12 lg:gap-16">
 {/* Scenarios */}
 <div className="lg:col-span-5">
 <h2 className="mb-6 lg:mb-8 text-5xl font-black uppercase leading-[0.9] tracking-tighter md:text-[4rem]">
 Is this
 <br />
 right for you?
 </h2>
 ...
 viewport={{ once: true }}
 className="relative border-[6px] border-foreground bg-card p-6 shadow-[15px_15px_0_0_hsl(var(--forest)/0.5)] md:p-6 lg:p-8 lg:col-span-7 lg:ml-8 lg:mt-8 lg:mt-12 lg:p-20 lg:shadow-[25px_25px_0_0_hsl(var(--forest)/0.5)]"
 >
 ...
 <h2 className="mb-10 border-b-4 border-foreground pb-8 text-[2rem] font-black uppercase tracking-tight sm:mb-6 lg:mb-8 sm:text-[3rem]">
 Initial Catalyst
 </h2>
 ...
 <section className="relative overflow-hidden border-t-[16px] border-foreground bg-background py-16 lg:py-24 md:py-16 lg:py-24 lg:py-48">
 ...
 <div className="group relative flex flex-col items-center justify-center gap-10 overflow-hidden border-[4px] border-foreground bg-foreground p-8 text-center text-background shadow-[15px_15px_0_0_hsl(var(--forest))] sm:border-[8px] sm:p-6 lg:p-8 md:p-24 lg:gap-12 lg:gap-16 lg:shadow-[30px_30px_0_0_hsl(var(--forest))]">
 {/* Watermark */}
...
function SubServiceCard({
 ...
 <Link
 href={href}
 className={`duration-[800ms] group relative flex h-full min-h-[450px] flex-col overflow-hidden bg-card p-6 transition-all sm:p-8 lg:p-6 lg:p-8 ${featured ? "bg-forest/5" : ""}`}
 >
 ...
 <div className="relative z-10 mb-6 lg:mb-8 flex items-start justify-between sm:mb-6 lg:mb-8">
 <Layers
...
function ApproachPanel({ step, title, desc }) {
 ...
 viewport={{ once: true }}
 variants={fadeIn}
 className="group/panel relative flex flex-1 flex-col overflow-hidden bg-card lg:flex-row"
 >
 ...
 <div className="relative z-20 flex flex-1 flex-col p-6 lg:p-8 transition-transform duration-500 ease-out group-hover/panel:-translate-y-3 lg:p-6 lg:p-8">
...
function ScenarioItem({ num, title, text }) {
 return (
 <div className="group relative flex flex-col gap-6 overflow-hidden bg-card p-6 text-card-foreground transition-colors hover:bg-mint-light sm:flex-row sm:gap-8 lg:p-6 lg:p-8">
...
function StartingPointCard({ title, subtitle, text }) {
 return (
 <div className="group relative overflow-hidden border-[4px] border-border bg-background p-6 shadow-sm transition-colors hover:shadow-[6px_6px_0_0_hsl(var(--forest)/0.2)] md:shadow-[10px_10px_0_0_hsl(var(--forest)/0.2)] group-hover:border-forest md:p-6 lg:p-8">
