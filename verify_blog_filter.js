...
const mockPosts = [
  ...
  {
    title: "Mixed Content",
    excerpt: "This is mostly English but has some foreign words like hola and mundo.",
...
console.log(`"The Future of AI": ${isEnglish("The Future of AI")} (Expected: true)`);
console.log(`"Aprendiendo Javascript": ${isEnglish("Aprendiendo Javascript")} (Expected: false)`);
...
if (filtered.length === 2 && filtered.some(p => p.title === "The Future of AI") && filtered.some(p => p.title === "Mixed Content")) {
