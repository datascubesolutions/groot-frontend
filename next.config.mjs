...
const nextConfig = {
  ...
  async headers() {
    ...
    const cspHeader = `
      ...
      font-src 'self' data:;
      connect-src 'self' https://region1.google-analytics.com https://www.google-analytics.com https://us-central1-datascube-2b74e.cloudfunctions.net https://*.a.run.app wss:;
      object-src 'none';
      base-uri 'self';
      form-action 'self';
